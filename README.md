...
This repository contains code to reproduce analyses and figures in our above manuscript.
...
```bibtex
@article{moore2026ere,
  title   = {Divergent regional trends in alpine tundra productivity linked to
             changes in snow-free season length and summer warming},
  author  = {Moore, Miles A.; Emery, Nancy C.; Elmendorf, Sarah C.},
  journal = {Environmental Research: Ecology},
  year    = {2026},
  doi     = {10.1088/2752-664X/ae6d04},
}
```
...
**Miles A. Moore** — Institute of Arctic and Alpine Research (INSTAAR) & Department of Ecology and Evolutionary Biology, University of Colorado Boulder


[🔗Contact me](milesalanmoore.github.io)
